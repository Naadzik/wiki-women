...
import { findCountry, findCountryRaw, onCountryClick, onAwardDateClick } from './app.js?v=19';
import { t, tPlural, getLang } from './i18n.js?v=19';
import { countAwardTypes } from './utils.js?v=19';
